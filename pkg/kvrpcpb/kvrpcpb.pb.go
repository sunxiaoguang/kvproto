...
type RawBatchScanRequest struct {
	...
	StartKeyLimit uint32   `protobuf:"varint,3,opt,name=start_key_limit,json=startKeyLimit,proto3" json:"start_key_limit,omitempty"`
	KeyOnly       bool     `protobuf:"varint,4,opt,name=key_only,json=keyOnly,proto3" json:"key_only,omitempty"`
}
...
func (m *RawBatchScanRequest) GetStartKeyLimit() uint32 {
	if m != nil {
...
func (m *RawBatchScanRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.StartKeyLimit != 0 {
		dAtA[i] = 0x18
		i++
		i = encodeVarintKvrpcpb(dAtA, i, uint64(m.StartKeyLimit))
	}
	if m.KeyOnly {
		dAtA[i] = 0x20
		i++
...
func (m *RawBatchScanRequest) Size() (n int) {
	...
	if m.StartKeyLimit != 0 {
		n += 1 + sovKvrpcpb(uint64(m.StartKeyLimit))
	}
	if m.KeyOnly {
		n += 2
	}
...
func (m *RawBatchScanRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field StartKeyLimit", wireType)
			}
			m.StartKeyLimit = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.StartKeyLimit |= (uint32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorKvrpcpb = []byte{
	...
	,
}
